...
const MyProfile = () => {
    ...
    const [UUID] = useState(userInfo.id);
    ...
    const [createdAt] = useState(parseISO(userInfo.created_at));
    const [updatedAt] = useState(parseISO(userInfo.updated_at));
    ...
    const onSubmitUpdateForm = async (e) => {
        ...
        const updateResult = await UpdateUserInfoByUserIdAPI(UUID, userInput);
        ...
        if (updateResult === true) {
            ...
            setUpdateMessage(<CAlert color="error">Cập nhật thất bại!</CAlert>);
        }
                            ...
                            <CCol sm="7">
                                ...
                                <CRow className="mt-2">
                                    <CCol>
                                        ...
                                        <p>{format(createdAt, 'dd-MM-yyyy HH:mm:ss')}</p>
                                    </CCol>
                                    <CCol>
                                        <CLabel htmlFor="updatedAt">Lần cập nhật gần nhất lúc:</CLabel>
                                        <p>{format(updatedAt, 'dd-MM-yyyy HH:mm:ss')}</p>
                                    </CCol>
                                </CRow>
